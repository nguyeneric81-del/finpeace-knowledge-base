...
```mermaid
graph TD
    A["Vùng Đất Hoang (Wasteland)<br>Nhận diện rào cản tâm lý & lo lắng"] --> B["Vùng Đất Kiểm Soát (Control)<br>Lập kế hoạch & phân bổ tài sản"]
    B --> C["Vùng Đất Bình An (Oasis)<br>Tích sản lâu dài & Tự do tài chính"]

    subgraph Tháp Tài Sản 3 Tầng
        T1["Tầng 1: Tài sản Bảo vệ<br>(Bảo hiểm & Quỹ khẩn cấp)"]
        T2["Tầng 2: Tài sản Ưu tiên<br>(Mua nhà, Hưu trí, Giáo dục)"]
        T3["Tầng 3: Tài sản Nâng cao<br>(Tích sản cổ phiếu & Giao dịch xu hướng)"]
    end
```
